...
install_deeplx(){
    ...
    wget -q -N --no-check-certificate -O /usr/bin/deeplx https://ghproxy.com/https://github.com/OwO-Network/DeepLX/releases/download/${last_version}/deeplx_linux_amd64

    chmod +x /usr/bin/deeplx
    wget -q -N --no-check-certificate -O /etc/systemd/system/deeplx.service https://ghproxy.com/https://raw.githubusercontent.com/OwO-Network/DeepLX/main/deeplx.service
